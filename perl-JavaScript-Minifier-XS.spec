...
%prep
%setup -q -n JavaScript-Minifier-XS-0.14
cd %{_builddir}
tar xf %{_sourcedir}/libjavascript-minifier-xs-perl_0.11-1.debian.tar.xz
cd %{_builddir}/JavaScript-Minifier-XS-0.14
mkdir -p deblicense/
cp -r %{_builddir}/debian/* %{_builddir}/JavaScript-Minifier-XS-0.14/deblicense/
...
cp %{_builddir}/JavaScript-Minifier-XS-0.14/LICENSE %{buildroot}/usr/share/package-licenses/perl-JavaScript-Minifier-XS/92e92d46bac9fa036a3d260671b6ce26398461d4
...
%files perl
%defattr(-,root,root,-)
/usr/lib/perl5/vendor_perl/5.34.0/x86_64-linux-thread-multi/JavaScript/Minifier/XS.pm
/usr/lib/perl5/vendor_perl/5.34.0/x86_64-linux-thread-multi/auto/JavaScript/Minifier/XS/XS.so
