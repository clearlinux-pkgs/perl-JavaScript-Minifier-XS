...
Version  : 0.12
Release  : 15
URL      : https://cpan.metacpan.org/authors/id/G/GT/GTERMARS/JavaScript-Minifier-XS-0.12.tar.gz
Source0  : https://cpan.metacpan.org/authors/id/G/GT/GTERMARS/JavaScript-Minifier-XS-0.12.tar.gz
...
%prep
%setup -q -n JavaScript-Minifier-XS-0.12
cd %{_builddir}
tar xf %{_sourcedir}/libjavascript-minifier-xs-perl_0.11-1.debian.tar.xz
cd %{_builddir}/JavaScript-Minifier-XS-0.12
mkdir -p deblicense/
cp -r %{_builddir}/debian/* %{_builddir}/JavaScript-Minifier-XS-0.12/deblicense/
...
cp %{_builddir}/JavaScript-Minifier-XS-0.12/LICENSE %{buildroot}/usr/share/package-licenses/perl-JavaScript-Minifier-XS/c5ee82fe20ef37bf6fa49ec78a87e5111ee51416
